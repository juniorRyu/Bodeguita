...
public class Categoria_IU extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Buscar Categorias", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Calibri", 0, 14))); // NOI18N
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        try {
            ...
            if (txtNombre.getText().length() > 0) {
                    ...
                    objeto_categoriaBD.registrarCategoria(objeto_categoria);
        ...
        try {
            if (txtId.getText().length() > 0) {
                if (txtNombre.getText().length() > 0) {
                        ...
                        objeto_categoriaBD.modificarCategoria(objeto_categoria);
        ...
        try {
            if (txtId.getText().length() > 0) {
                ...
                if (aviso == 0) {
                    ...
                    objeto_categoriaBD.eliminarCategoria(codigo);
